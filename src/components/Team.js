...
const Team=()=> {
    return (
        <div name="team">
            ...
            <div className="w-full bg-gray-100 px-5 pt-5">
                    ...
                    <div className="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                            ...
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://res.cloudinary.com/di4su7hro/image/upload/v1666368765/HYDE%20UG/WhatsApp_Image_2022-10-21_at_18.53.51_czvd24.jpg" alt className="rounded-full object-cover h-full w-full shadow-md" loading={React.lazy()}/>
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Watera Sheilah</div>
                                    <p className="text-gray-800 text-sm text-center">Senior Developer</p>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Jjumba Eric Benjamin</div>
                                    <p className="text-gray-800 text-sm text-center">Senior Developer</p>
